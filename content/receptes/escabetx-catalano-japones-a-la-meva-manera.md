---
title: "Escabetx catalano-japonès a la meva manera"
date: 2025-01-14
draft: false
categories:
  - entrants
tags:
  ...
  - "escabetx"
  - "gastronomia"
image: "/images/receptes/IMG_2254.jpg"
lead: "Fa ja temps, en un restaurant japonès vaig provar els escabetxos tradicionals que fan al seu país. Vaig tenir-ne curiositat i mai ho oblidaré, em van encantar. Aconsegueixen que les verdures escabetxa"
dificultat: ""
temps: ""
racions: 4
---
...
Els encurtits japonesos, coneguts com a **[Tsukemono](https://ca.wikipedia.org/wiki/Tsukemono)** , es preparen mitjançant diverses tècniques tradicionals:
...
### Per la preparació cal seguir aquestes passes:
  ...
  1. Rentar i tallar regularment (més fina que gruixada) les verdures. Jo faig servir talladors de formes per tal que quedi més bonic i, també, el líquid de l'escabetx entri bé a tota la superfície de cada trosset de verdura.
  2. En un recipient posarem cada verdura i li afegirem sal gruixuda en una bona quantitat i remenarem bé per tal que quedi ben «salat» tot el conjunt. Això es fa perquè les verdures deixin anar la seva aigua. Les deixarem entre mitja i una hora. 
  3. En un recipient ben gran aclarirem les verdures per retirar-ne tota la sal. Coleu-les després per deixar-les el més seques que pugueu.
  4. Eixugar bé les verdures amb un drap de cuina net o paper de cuina.
  5. Afegiu les verdures, cada una en un pot diferent o barrejades segons el vostre gust, en un pot ben net.
  6. Afegirem uns grans de pebre negre (si pot ser de Sichuan millor) i una fulla de llorer. Opcionalment i podeu posar un bitxo per donar-li un xic d'alegria.
  7. Acabeu d'emplenar el pot amb el líquid encara ben calent de l'escabetx que hem preparat a la primera part. És important que el líquid cobreixi totalment les verdures.
  8. Deixeu que es refredi i tapeu bé el pot amb la seva tapa.
  9. Conserveu a la nevera. En teoria, no estic ben segur, hauria d'aguantar un mes aproximadament ben tapat a la nevera, però ja que he fet el que m'ha rotat barrejant les dues receptes doncs millor menjar-ho ràpid!
